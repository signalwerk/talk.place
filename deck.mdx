...
![](https://cdn.jsdelivr.net/gh/signalwerk/talk.place@fee64b416e87e0443b8de14b5a0833d9a37c619d/assets/board.png)
...
* If you use in a Frontend-Framework *mutations* on store – you can send them to all «connected stores» via server
